...
|                   |                                   |                      Parity / stop | Multipoint enable | `207.mE`                              | **0 (off) initially**                                                                                                                                                                                                          | Two-point calibration is the highest ROI default; only open multipoint if residual nonlinearity is measured. | `503.so` | **1** | Lowest overhead, simplest integration. |
...
|                   |                                   |                                    |                   |                                       |                                                                                                                                                                                                                                |
|           **4.A** |   **Calibration via Datasheet**   |               Set Calibration mode |     `201.Mo`      | **Data**                              | Real-load calibration is higher-epistemic than datasheet-only entry for a reference instrument.                                                                                                                                |
...
|                   |                                   |                                    |                   |                                       |                                                                                                                                                                                                                                |
|           **4.B** | **Calibration via Known Weights** |               Set Calibration mode |     `201.Mo`      | **Load**                              | Real-load calibration is higher-epistemic than datasheet-only entry for a reference instrument.                                                                                                                                |
