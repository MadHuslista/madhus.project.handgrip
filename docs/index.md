...
- Start with the reader pathway that matches your purpose, then follow the workflow or component-specific links.
- The documentation is organized from **operation-only workflows** to **architecture/configuration** to **implementation/development**.

## Reader pathways

| Reader / task                  | Start here                                                                                         | Then read                                                                                                                                                                              | Goal                                                                                  |
| ------------------------------ | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| I want to start from zero      | [`start-here.md`](start-here.md)                                                                   | [`system-overview.md`](system-overview.md)                                                                                                                                             | Understand the purpose, hardware, software processes, and first workflow.             |
...
## Components specific documentation
...
## Component Data Exchange Contracts

Details about the expected data formats, stream names, and protocols used for communication between components and processes.
