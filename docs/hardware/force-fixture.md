...
Use this document before executing Handgrip calibration. Use `docs/hardware/pm58-wiring-and-bringup.md` for electrical wiring and `docs/hardware/acquisition-board-reference.md` for acquisition-board menus.
...
- [ ] PM58 wiring has passed the bring-up checklist in `pm58-wiring-and-bringup.md`.
