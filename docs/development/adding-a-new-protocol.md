...
| `Handgrip_Calibration/docs/protocols.md`           | Add protocol status and intended use.                         |
| `Handgrip_Calibration/docs/configuration.md`       | Document any new config keys/sections.                        |
| `Handgrip_Calibration/docs/recording.md`           | Update capture/session expectations if outputs change.        |
| `Handgrip_Calibration/docs/reports-and-outputs.md` | Document new report/output artifacts.                         |
| `docs/workflows/handgrip-calibration.md`           | Update only if protocol becomes operator-facing or canonical. |
...
10. Document protocol status in `protocols.md`.
