...
This is the correct calibration relationship; do **not** fit against `target_current_units` unless you are specifically validating already-deployed firmware constants. The docs refactor notes explicitly preserve this as the core fitting invariant and the command ladder as the workflow owner. 
